      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
            {!loading && listings.length === 0 && (
                <p className="text-xl font-bold text-slate-700 text-center w-full">No Listings Found!!</p>
            )}
            {loading && (
                <p className="text-xl font-semibold text-slate-700 text-center w-full">Loading...</p>
            )}
