        ...
        <p className="text-sm self-center">
          {
            ...
            filePrec > 0 && filePrec < 100 ? (<span className="text-slate-700">{`Uploading ${filePrec}%`}</span>) :
            filePrec === 100 ? (<span className="text-green-700">Image Successfully Uploaded!!</span>) : ('')
          }
        </p>
        <input
          type="text"
